...
const LoginPage = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href = `${process.env.NEXT_PUBLIC_BASE_URL}/auth/google?userType=jobseeker`;
  };
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/50">
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <a href="/auth/register" className="text-[#1c398e] hover:text-blue-600 font-semibold transition-colors hover:underline">
                Sign up as Job Seeker
              </a>
              <span className="text-gray-400">|</span>
              <a href="/recruiter/register" className="text-[#1c398e] hover:text-blue-600 font-semibold transition-colors hover:underline">
